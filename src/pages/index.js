...
const features = [
  {
    ...
    quote: "I love that I can easily create and remove upsells to go along with our current promotions!",
  ...
  },
  {
    ...
    quote: "Our customers really love the last minute chance to pickup and item may have forgotten.",
  ...
  },
  {
    ...
    quote: "You can customize so it shows directly in your cart, no intrusive popups!",
        ...
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
            <div className="absolute inset-0">
              <img className="h-full w-full object-cover" src={useBaseUrl('img/iStock-1133980246.jpg')} alt="Boxes on top of Laptop" />
            ...
            <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
              ...
              <p className="mt-6 max-w-lg mx-auto text-center text-xl text-indigo-200 sm:max-w-3xl">
                Use our Shopify app to encourage additional purchases before your customers checkout.
              </p>
              <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-1 sm:gap-5">
                  <a href="/docs" className="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-indigo-700 bg-white hover:bg-indigo-50 sm:px-8">
                    Get started
                  </a>
                </div>
              </div>
          ...
          {features.map((feature, idx) => (
            <div key={idx} className={idx == 0 ? "relative" : "mt-24"}>
              <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
                <div className={"px-4 max-w-xl mx-auto sm:px-6 lg:max-w-none lg:mx-0 lg:px-0 " + (((idx % 2) == 0) ? "lg:py-16" : "lg:py-32 lg:col-start-2")}>
                  <div>
                    <div>
                    ...
                    <div className="mt-6">
                      ...
                      <div className="mt-6">
                        <a href="/docs" className="inline-flex px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700">
                          Get started
                        </a>
                      </div>
                    </div>
                ...
                <div className="mt-12 sm:mt-16 lg:mt-0">
                  <div className="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                    <img className={"w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:h-full lg:w-auto lg:max-w-none " + (((idx % 2) == 0) ? "lg:left-0" : "lg:right-0")} src={feature.imageUrl} alt="Inbox user interface" />
                  </div>
                </div>
              </div>
            </div>
