...
Shopify started dropping support for IE 11 in their themes in March 2020, so if you are using a recent theme, your store might not 
function at all in IE 11.
